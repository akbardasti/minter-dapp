const contractAddress = "0xa2255b42d21ae8cd28c277550715ecd69b9a2194"; //Replace with your own contract address
const chain = "rinkeby"; // rinkeby or polygon

const welcome_h1 = "Welcome to Facebox!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = "We are V2.";
const h1_presale_coming_soon = "NFT Drop Coming Soon!!";
const h1_presale_mint = "Pre-Sale Minting Open!!";
const h1_public_mint = "Public Sale Closed!";
